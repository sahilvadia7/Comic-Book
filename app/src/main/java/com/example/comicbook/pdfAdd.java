   ...
   //arrayList to hold pdf categories
    ...
    private void validateData() {
        ...
        if (TextUtils.isEmpty(title)) {
           ...
           //all data is valid,can upload pdf
            uploadPdfToStorage();
        }
        }
    ...
    private void uploadPdfInfoToDb(String uploadedPdfUrl, long timestamp) {
        ...
        //setup data to upload, also view count, download
        ...
        ref.child(""+timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(pdfAdd.this, "Successfully uploaded", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(pdfAdd.this,"Fail to upload to db due to"+e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
